      ...
      <div className="separar container-fluid text-center">
        <div className="row align-items-start text-white tamaños-letras-chicas">
          <div className="col mt-4">
            <img src={imagen1} height="250px" width="" className="img-fluid tilt-in-fwd-tr" alt="Imagen 1" />
          </div>
          <div className="col-6 mt-4">
            <img src={imagen2} height="250px" width="" className="img-fluid tilt-in-fwd-tr" alt="Imagen 2" />
          </div>
          <div className="col-6 mt-4">
            <img src={imagen3} height="250px" width="" className="img-fluid tilt-in-fwd-tr" alt="Imagen 3" />
          </div>
          <div className="col-6 mt-4">
            <img src={imagen4} height="250px" width="" className="img-fluid tilt-in-fwd-tr" alt="Imagen 4" />
          </div>
          <div className="col-6 mt-4">
            <img src={imagen5} height="250px" width="" className="img-fluid tilt-in-fwd-tr" alt="Imagen 5" />
          </div>
          <div className="col-6 mt-4">
            <img src={imagen6} height="250px" width="" className="img-fluid tilt-in-fwd-tr" alt="Imagen 6" />
          </div>
        </div>
